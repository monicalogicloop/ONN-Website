    ...
    <header>
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto d-none d-md-block menu_area">
                    <nav class="main-nav">
                        <ul>
                            <li>
                                        ...
                                        <div class="col-7 section-heading">
                                            ...
                                            <div class="row mt-5">
                                                @foreach ($menuCategories1 as $categoryKey => $categoryValue)
                                                    <div class="menu-category__single col-4 mt-5">
                                ...
                                <div class="sub-menu mega-menu">
                                    <div class="row">
                                        ...
                                        <div class="col-2 section-heading trending-collection">
                                            ...
                                            <div class="menutrending__slider swiper-container">
                                                <div class="slider swiper-wrapper">
                                                    @foreach($outerwearTrendingProducts as $productKey => $productValue)
                                                        <div class="home-product_wrapper swiper-slide">
                                                            <a href="{{ route('front.product.detail', $productValue->slug) }}">
                                                                <img src="{{asset($productValue->image)}}" class="w-100" />
                                                                <h4 class="mt-2 p-2">{{$productValue->name}}</h4>
                                        ...
                                        <div class="col-3 section-heading">
                                            ...
                                            <div class="row">
                                                <div class="col p-2">
                                                    <img src="{{ asset('img/home/menu-outerwear-collection_01.png') }}" class="w-100">
                                                </div>
                                                <div class="col p-2">
                                                    <img src="{{ asset('img/home/menu-outerwear-collection_02.png') }}" class="w-100">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col p-2">
                                                    <img src="{{ asset('img/home/menu-outerwear-collection_03.png') }}" class="w-100">
                                                </div>
                                                <div class="col p-2">
                                                    <img src="{{ asset('img/home/menu-outerwear-collection_04.png') }}" class="w-100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="sub-menu mega-menu">
                                    <div class="row">
                                        ...
                                        <div class="col-2 section-heading trending-collection">
                                            ...
                                            <div class="menutrending__slider swiper-container">
                                                <div class="slider swiper-wrapper">
                                                    @foreach($winterwearTrendingProducts as $productKey => $productValue)
                                                        <div class="home-product_wrapper swiper-slide">
                                                            <a href="{{ route('front.product.detail', $productValue->slug) }}">
                                                                <img src="{{asset($productValue->image)}}" class="w-100" />
                                                                <h4 class="mt-2 p-2">{{$productValue->name}}</h4>
                                        ...
                                        <div class="col-3 section-heading">
                                            ...
                                            <div class="row">
                                                <div class="col p-2">
                                                    <img src="{{ asset('img/home/menu-winterwear-collection_01.png') }}" class="w-100">
                                                </div>
                                                <div class="col p-2">
                                                    <img src="{{ asset('img/home/menu-winterwear-collection_02.png') }}" class="w-100">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col p-2">
                                                    <img src="{{ asset('img/home/menu-winterwear-collection_03.png') }}" class="w-100">
                                                </div>
                                                <div class="col p-2">
                                                </div>
                                            </div>
                                ...
                                <div class="sub-menu mega-menu">
                                    <div class="row">
                                        <div class="col-7 section-heading">
                                            ...
                                            <div class="row">
                                                {{-- @foreach ($menuCategories4 as $categoryKey => $categoryValue)
                                                    <div class="menu-category__single col-4 mt-5">
                                                        <a href="{{ route('front.category.detail', $categoryValue->slug) }}" class="category-card">
                                                            <div class="content-wrapper">
                                                                <h3>{{$categoryValue->name}}<span>.</span></h3>
                                ...
                                <div class="sub-menu mega-menu">
                                    <div class="row">
                                            ...
                                            <div class="row mt-5">
                                                @foreach ($menuCategories5 as $categoryKey => $categoryValue)
                                                    <div class="menu-category__single col-4 mt-5">
                                                        <a href="{{ route('front.category.detail', $categoryValue->slug) }}" class="category-card">
                                                            <div class="content-wrapper">
                                                                <h3 style="width: 65%;">{{$categoryValue->name}}<span>.</span></h3>
                                                            </div>
                                                            <div class="image-wrapper">
                                                                <img src="{{asset($categoryValue->home_image)}}" />
                                                            </div>
                                        ...
                                        <div class="col-2 section-heading trending-collection">
                                            ...
                                            <div class="menutrending__slider swiper-container">
                                                <div class="slider swiper-wrapper">
                                                    @foreach($accessoriesTrendingProducts as $productKey => $productValue)
                                                        <div class="home-product_wrapper swiper-slide">
                                                            <a href="{{ route('front.product.detail', $productValue->slug) }}">
                                                                <img src="{{asset($productValue->image)}}" class="w-100" />
                                                                <h4 class="mt-2 p-2">{{$productValue->name}}</h4>
                                        ...
                                        <div class="col-3 section-heading">
                                            ...
                                            <div class="row">
                                                <div class="col p-2">
                                                    <img src="{{ asset('img/home/menu-accessories-collection_01.png') }}" class="w-100">
                                                </div>
                                                <div class="col">
                                                </div>
                                            </div>
