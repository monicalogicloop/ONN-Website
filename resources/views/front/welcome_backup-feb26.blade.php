                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-11">
                                <div class="shop-category-image">
                                    <img src="{{ asset('img/home/Gym_v3.png') }}" class="img-fluid w-100 shop-main-image">
                                    <!-- Dot 1 -->
                                    <span class="hotspot"
                                    ...
                                    <span class="hotspot"
                                            ...
                                            data-link="https://onninternational.com/product/half-pant-french-terry"
...
<script>
    ...
    $('.shop-look').on('mouseenter', '.hotspot', function () {
        const container = $(this).closest('.shop-category-image');
        const card = container.find('.shop-look-product-card');

        // 1️⃣ Hide immediately
        card.hide();

        // 2️⃣ Clear old content
            ...
            <div class="col">
                <div class="our-exclusives__single swiper-slide">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3">
                            <div class="grid-box text-center mb-5">
                                <img src="{{ asset('img/home/our-exclusives_product3_03.png') }}" alt="" id="our-exclusives_image3">
                            </div>
                        </div>
                        <div class="col-xl-3">
                            <div class="grid-box text-center">
