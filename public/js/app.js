...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelectorAll(".category-left").forEach(function (btn) {
        btn.addEventListener("click", function () { category__slider.slidePrev(800); });
    });
    document.querySelectorAll(".category-right").forEach(function (btn) {
        btn.addEventListener("click", function () { category__slider.slideNext(800); });
    });
    ...
    document.querySelectorAll(".home-collection-left").forEach(function (btn) {
        btn.addEventListener("click", function () {
            ...
            setTimeout(function () { isSliding = false; }, 600); // slightly more than speed
        });
    });
    ...
    var outerwearTabTrigger = document.querySelector('[data-bs-target="#outerwear"]');
    if (outerwearTabTrigger) {
        outerwearTabTrigger.addEventListener('shown.bs.tab', function () {
...
//     centeredSlides: false,
//     allowTouchMove: true,
//     slideToClickedSlide: false,  // ✅ removed — causes jump/teleport with loop
...
// document.querySelectorAll(".inner-outer-collection-right").forEach(function (btn) {
//     btn.addEventListener("click", function () {
//         collection__slider.slideNext(800);
//     });
// });

// document.querySelectorAll(".inner-outer-collection-left").forEach(function (btn) {
//     btn.addEventListener("click", function () {
//         collection__slider.slidePrev(800);
//     });
// });
...
// $('.shop-look .shop-look-product-card2').css('display', 'none');
// $('.shop-look .shop-look-product-card3').css('display', 'none');
// $('.shop-look .shop-look-product-card4').css('display', 'none');
...
//   $('.shop-look .shop-look-product-card1').css('display', 'flex');
...
// $('.hotspot2').on('mouseenter click', function () {
//   const shoplink2   = $(this).data('link');
//   const shopimg2   = $(this).data('img');
//   const shopname2  = $(this).data('name');
//   const shopprice2 = $(this).data('price');
//   $('.shop-look .shop-look-product-card2').css('display', 'flex');
//   $('#shopproductLink2').attr('href', shoplink2);
//   $('#shopproductImage2').attr('src', shopimg2);
//   $('#shopproductName2').text(shopname2);
//   $('#shopproductPrice2').text(shopprice2);

//   $('.product-card').fadeIn(200);
// });

// $('.hotspot3').on('mouseenter click', function () {
//   const shoplink3   = $(this).data('link');
//   const shopimg3   = $(this).data('img');
//   const shopname3  = $(this).data('name');
//   const shopprice3 = $(this).data('price');
//   $('.shop-look .shop-look-product-card3').css('display', 'flex');
//   $('#shopproductLink3').attr('href', shoplink3);
//   $('#shopproductImage3').attr('src', shopimg3);
//   $('#shopproductName3').text(shopname3);
//   $('#shopproductPrice3').text(shopprice3);

//   $('.product-card').fadeIn(200);
// });

// $('.hotspot4').on('mouseenter click', function () {
//   const shoplink4   = $(this).data('link');
//   const shopimg4   = $(this).data('img');
//   const shopname4  = $(this).data('name');
//   const shopprice4 = $(this).data('price');
//   $('.shop-look .shop-look-product-card4').css('display', 'flex');
//   $('#shopproductLink4').attr('href', shoplink4);
//   $('#shopproductImage4').attr('src', shopimg4);
//   $('#shopproductName4').text(shopname4);
//   $('#shopproductPrice4').text(shopprice4);
...
$(document).ready(function () {
    $('.outerwear-image1-first')
        .addClass('active')
        .trigger('click');
    $('.outerwear-image2-first')
        .addClass('active')
        .trigger('click');
    $('.outerwear-image3-first')
        .addClass('active')
        .trigger('click');
    $('.outerwear-image4-first')
        .addClass('active')
        .trigger('click');
});
...
//   const img4 = $(this).data('img4');
//   const name1   = $(this).data('name1');
//   const name2   = $(this).data('name2');
//   const name3  = $(this).data('name3');
//   const name4 = $(this).data('name4');
//   const link1   = $(this).data('link1');
//   const link2   = $(this).data('link2');
//   const link3  = $(this).data('link3');
//   const link4 = $(this).data('link4');
//   $('#comfort_img1').attr('src', img1);
//   $('#comfort_img2').attr('src', img2);
//   $('#comfort_img3').attr('src', img3);
//   $('#comfort_img4').attr('src', img4);
//   $('#comfort_name1').text(name1);
//   $('#comfort_name2').text(name2);
//   $('#comfort_name3').text(name3);
//   $('#comfort_name4').text(name4);
//   $('#comfort_link1').attr('href', link1);
//   $('#comfort_link2').attr('href', link2);
//   $('#comfort_link3').attr('href', link3);
//   $('#comfort_link4').attr('href', link4);
// //   $('#our-exclusives_center').attr('src', centerimg);
// //   $('#our-exclusives_center_name').text(centername);
// //   $('#our-exclusives_center_link').attr('href', centerlink);
// });

// // Set first bar as active by default on page load
// $('.our-exclusives-color').first().addClass('active');
...
function updateComfortSection($el) {
    ...
    for (let i = 1; i <= 4; i++) {
        ...
        if (!name || !link || link === '#') {
            ...
            // Hide immediately so the old image never shows
            $img.css('visibility', 'hidden');

            // Swap name & link right away (text is instant)
            ...
            $img
                ...
                .one('error', function () {
                    $(this).css('visibility', 'visible'); // show broken img rather than blank forever
                });

            // Trigger load — if browser already cached it, 'load' fires synchronously
            $img.attr('src', img);
...
// Default: activate first bar on load
