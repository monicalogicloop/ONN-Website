...
var inneroutercollection__slider = new Swiper(".home-inner-outer-collection__slider", {
    direction: "horizontal",
    loop: true,
    speed: 2000,
    autoplay: {
...
$('.our-exclusives-color').on('mouseenter click', function () {
  ...
  const centerimg = $(this).data('centerimg');
  const centername = $(this).data('centername');
  const centerlink = $(this).data('centerlink');
  $('#our-exclusives_image1').attr('src', img1);
  $('#our-exclusives_image2').attr('src', img2);
  $('#our-exclusives_image3').attr('src', img3);
  $('#our-exclusives_image4').attr('src', img4);
